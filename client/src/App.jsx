...
function App() {
  const { data, loading, refreshData, analyzeTechnology } = useTechnologies();
      ...
      <header className="bg-white border-b border-neutral-200 sticky top-0 z-10 dark:bg-neutral-900 dark:border-neutral-800">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex-1 max-w-md mx-8">
            ...
            <div className="text-[10px] text-neutral-400 mt-1 pl-3">
              Press Enter to analyze new tech
            </div>
          </div>
